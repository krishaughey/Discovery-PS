...
$colItems = Test-NetConnection -ComputerName $Server -Port 445 | Select-Object ComputerName,RemoteAddress,RemotePort,TcpTestSucceeded
...
$Array | Export-Csv "c:\Temp\Port_445_Status_$timestamp.csv" -NoTypeInformation
Write-Host "results have been exported to "c:\Temp\Port_445_Status_$timestamp.csv"" -ForegroundColor Cyan
