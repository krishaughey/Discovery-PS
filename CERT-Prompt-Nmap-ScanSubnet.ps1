...
$TempDir = Read-Host -Prompt "Enter the path to a temp directory"
$TempFile = "CertScan"
$TargetList = Read-Host -Prompt "Enter the full path and name of the target list (e.g. - c:\Temp\TargetList.csv)" | Import-csv
